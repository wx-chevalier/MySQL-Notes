  ...
  - [3 表与查询优化](/表与查询优化/README.md)
    ...
    - [3.4 索引优化](/表与查询优化/索引优化/README.md)
      ...
      - [3.4.2 索引介绍](/表与查询优化/索引优化/索引介绍.md)
      - [3.4.3 索引基础](/表与查询优化/索引优化/索引基础.md)
      - [3.4.4 避免索引失效](/表与查询优化/索引优化/避免索引失效.md)
  ...
  - [6 架构与存储引擎](/架构与存储引擎/README.md)
    ...
    - [6.2 事务与锁](/架构与存储引擎/事务与锁/README.md)
      - 6.2.1 事务
        - [6.2.1.1 MVCC 实现](/架构与存储引擎/事务与锁/事务/MVCC%20实现.md)
        - [6.2.1.2 事务日志](/架构与存储引擎/事务与锁/事务/事务日志.md)
      - [6.2.2 锁](/架构与存储引擎/事务与锁/锁/README.md)
        - [6.2.2.1 共享锁与排他锁](/架构与存储引擎/事务与锁/锁/共享锁与排他锁.md)
        - [6.2.2.2 加锁流程浅析](/架构与存储引擎/事务与锁/锁/加锁流程浅析.md)
        - [6.2.2.3 行锁与死锁](/架构与存储引擎/事务与锁/锁/行锁与死锁.md)
    ...
    - [6.4 语句解析与处理](/架构与存储引擎/语句解析与处理/README.md)
      ...
      - [6.4.2 复杂查询](/架构与存储引擎/语句解析与处理/复杂查询.md)
      - [6.4.3 查询优化](/架构与存储引擎/语句解析与处理/查询优化.md)
