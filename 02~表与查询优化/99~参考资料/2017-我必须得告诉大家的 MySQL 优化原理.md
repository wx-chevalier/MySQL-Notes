...
![MySQL 逻辑架构](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230402155514.png)
...
![MySQL 请求处理过程](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230402160908.png)
...
![平衡二叉树](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230402162310.png)
...
![二叉树](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230402162342.png)
...
![简化后的二叉树](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230402163056.png)
...
![插入 28 节点](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230402163515.png)

接着插入下一个节点 70，在 Index Page 中查询后得知应该插入到 50 - 70 之间的叶子节点，但叶子节点已满，这时候就需要进行也分裂的操作，当前的叶子节点起点为 50，所以根据中间值来拆分叶子节点，如下图所示。

![叶子节点分裂](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230402163557.png)

最后插入一个节点 95，这时候 Index Page 和 Leaf Page 都满了，就需要做两次拆分，如下图所示。

![两次拆分](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230402163632.png)

拆分后最终形成了这样一颗树。

![两次拆分后形成的树](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230402163702.png)
...
![左旋操作](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230402163725.png)
